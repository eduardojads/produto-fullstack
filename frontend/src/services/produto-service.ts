...
export async function updateProduto(produtoId: number, requestBody: ProdutoUpdateDTO): Promise<ProdutoDTO> {
    const response = await axios.put(`${BASE_URL}/produtos/${produtoId}`, requestBody);
